...
class IndexTest(unittest.TestCase):
    ...
    @patch('api.index.upload_file')
    def test_generate_cover_letter_with_no_required_data(self, upload_file_mock):
        data = {
            "profile": {
                "fullName": "John Doe",
                "address": "fasfas",
        ...
        self.assertEqual(result["message"], "Error while generating cover letter!")
        
    @patch('api.index.upload_file')
    def test_generate_cover_letter_with_no_profile(self, upload_file_mock):
        data = {
            "jobTitle": "backend engineer",
            "companyName": "XYZ",
        }
