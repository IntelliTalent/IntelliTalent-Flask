...
def wuzzuf_scrape():
	...
	data = {"startIndex":0,"pageSize":10,"longitude":"0","latitude":"0","query":job ,"searchFilters":{}}
	data = json.dumps(data)
	job_search_json = requests.post(wuzzuf_search_api , headers=headers , data=data).json()
	logger.debug(job_search_json)
	...
	logger.debug(company_details_json)
